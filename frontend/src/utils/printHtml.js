...
export function exportHtmlAsExcel(html, filename) {
    ...
    // Strip every <style> block — we'll replace them with our own uniform sheet
    ...
    // Every element: strip font-size, font-family, and width inline styles
    // so nothing overrides our uniform stylesheet below
    ...
    // Heading rows — keep bold + light grey background
    ...
    // Replace all styles with one uniform sheet
