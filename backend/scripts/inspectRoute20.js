...
function parseTggMessages(rawText) {
    ...
    try {
        ...
        // Expecting structure: { "AP39VA1853": { "0": { "time": "...", "y": lat, "x": lng }, "1": { ... } } }
...
// Helper to add a delay between API calls to prevent rate limits
...
async function run() {
    ...
    try {
        ...
        for (const interval of intervals) {
            ...
            await delay(150); // Be nice to TGG API
        }
        ...
        for (const stage of stages) {
            ...
            // Consider it a valid match if within 500m
